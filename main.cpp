...
void createMeshes()
{
	...
	std::vector <Vertex*> billboard;
	Vertex* billboardVert = new Vertex_Pos_Col(XMFLOAT3(2.0f, 8.0f, -3.0f), XMFLOAT3(1.0f, 1.0f, 1.0f));
	billboard.push_back(billboardVert);
	gBillboard = new Mesh(billboard, gDevice);
}
...
void createTriangleData()
{
	...
	bufferDesc.ByteWidth = sizeof(gPillar->getBoundingVolume()->getVertices());
...
void renderBillboard()
{
	...
	gDeviceContext->Draw(gBillboard->getVertCount(), 0);
}
